        ...
        */
        ...
        r.prototype.init = function (e) {
            ...
            try {
                var n = e.lang || "",
                    ...
                    l = e.avatarForce,
                    c = e.avatar_cdn || "";
                n && r && t.installLocale(n, r), t.locale = t.locale || v[e.lang || "zh-cn"], t.notify =
                    e.notify || !1, t.verify = e.verify || !1;
                var d = l ? "&q=" + Math.random().toString(32).substring(2) : "";
                g.params = "?d=" + (i.indexOf(a) > -1 ? a : "mp") + "&v=" + o + d, g.hide = "hide" ===
                    a, g.cdn = !!c && c || g.cdn, x = e.path || x;
                ...
                for (var _ = u.findAll(document, ".valine-comment-count"), A = 0, O = _.length; A <
                    O; A++) ! function (e, n) {
                    var r = _[e];
                    if (r) {
                ...
                t.el = S, t.el.classList.add("v"), g.hide && t.el.classList.add("hide-avatar"), e.meta =
                    (e.guest_info || e.meta || m).filter(function (e) {
                        return m.indexOf(e) > -1
                    });
                var E = (0 == e.meta.length ? m : e.meta).map(function (e) {
                    var n = "mail" == e ? "email" : "text";
                    return m.indexOf(e) > -1 ? '<input name="' + e + '" placeholder="' + t.locale
                        .head[e] + '" class="v' + e + ' vinput" type="' + n + '">' : ""
                });
                t.placeholder = e.placeholder || "Just Go Go", t.el.innerHTML =
                    '<div class="vwrap"><div class="vheader item' + E.length + '">' + E.join("") +
                ...
                t.nodata = {
                    show: function (e) {
                        return C.innerHTML = e || t.locale.tips.sofa, u.attr(C, "style",
                            "display:block;"), t
                    },
                    hide: function () {
                ...
                t.loading = {
                    show: function (e) {
                        ...
                        return e ? L.insertBefore(M, n[0]) : L.appendChild(M), t.nodata.hide(),
                            t
                    },
                    hide: function () {
                        var e = u.find(L, ".vloading");
                        return e && u.remove(L, e), 0 === u.findAll(L, ".vcard").length &&
                            t.nodata.show(), t
                    }
                };
                ...
                t.alert = {
                    show: function (e) {
                        T.innerHTML = '<div class="valert txt-center"><div class="vtext">' +
                            (e && e.text || 1) + '</div><div class="vbtns"></div></div>';
                        var n = u.find(T, ".vbtns"),
                            r = '<button class="vcancel vbtn">' + (e && e.ctxt || t.locale.ctrl
                                .cancel) + "</button>",
                            i = '<button class="vsure vbtn">' + (e && e.otxt || t.locale.ctrl
                                .sure) + "</button>";
                        if (n.innerHTML = "" + r + (e && e.type && i), u.on("click", u.find(
                                T, ".vcancel"), function (e) {
                                t.alert.hide()
                    ...
                    if (n.length) {
                        ...
                        i.containedIn("url", n), i.find().then(function (e) {
                            e.length > 0 && u.each(e, function (e, t) {
                                var n = t.get("url"),
                                    r = t.get("time"),
                                    i = u.find(document, '.leancloud_visitors[id="' +
                                        n + '"]') || u.find(document,
        ...
        r.prototype.Q = function (e) {
            if (1 == arguments.length) {
                ...
                return r.equalTo("url", decodeURI(e)), r.addDescending("createdAt"), r.addDescending(
                    "insertedAt"), r
            }
            ...
            t.emoji = {
                ...
                show: function () {
                    return t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML =
                        h.comment, u.attr(r, "style", "display:block"), T(), t.preview
                },
                hide: function () {
            ...
            var m = function (e) {
                    ...
                    return u.each(n, function (e, n) {
                        1 === n.nodeType && (r.indexOf(n.nodeName) > -1 && ("INPUT" === n.nodeName &&
                                "checkbox" === u.attr(n, "type") ? u.attr(n, "disabled",
                                    "disabled") : u.remove(t, n)), "A" === n.nodeName &&
                            i(n, "href"), u.clearAttr(n))
                    }), t.innerHTML
                },
                y = function (e) {
                    var t = e.value || "";
            ...
            for (var $ in A) A.hasOwnProperty($) && function () {
                ...
                _[e] = n, n && u.on("input change blur", n, function (t) {
                    "comment" === e ? y(n) : h[e] = u.escape(n.value.replace(
                        /(^\s*)|(\s*$)/g, ""))
                })
            }();
            var E = function (e, t) {
            ...
            var L = function (e, n, r) {
                    var i = u.create("div", {
                        ...
                        o = g.hide ? "" : '<img class="vimg" src="' + (g.cdn + a(e.get("mail")) + g
                            .params) + '">',
                        s = e.get("ua") || "",
                        l = "";
                    if (s) {
                    ...
                    p = f ? '<a class="vnick" rel="nofollow" href="' + f + '" target="_blank" >' +
                        ...
                        '" cid="' + e.id + '" at="@' + u.escape(e.get("nick")) + '" mail="' + e.get(
                            "mail") + '" class="vat">' + t.locale.ctrl.reply +
                        '</span>\n                </div>\n                <div class="vcontent">\n                    ' +
                        m(e.get("comment")) + "\n                </div>\n            </div>";
                    for (var h = u.find(i, ".vat"), v = u.findAll(i, "a"), b = 0, x = v.length; b <
                        x; b++) {
                        var y = v[b];
            ...
            var j = function () {
                    h.comment = "", _.comment.value = "", y(_.comment), u.attr(_.comment,
                ...
                P = function (e) {
                    ...
                    var n = k.mail(h.mail),
                        r = k.link(h.link);
                    h.mail = n.k ? n.v : "", h.link = r.k ? r.v : "", t.notify || t.verify ? V(Q) :
                        Q()
                },
                U = function () {
                    var e = new AV.ACL;
                ...
                Q = function () {
                    ...
                    if (h.url = decodeURI(x), h.insertedAt = new Date, R.rid) {
                        var r = R.pid || R.rid;
                        n.set("rid", R.rid), n.set("pid", r), h.comment = '<a class="at" href="#' +
                            r + '">' + R.at + "</a>" + h.comment
                    }
                    for (var i in h)
                        ...
                        try {
                            if (R.rid) {
                                var i = u.find(t.el, '.vquote[rid="' + R.rid + '"]') || C(R
                                    .rid);
                                L(e, i, !0)
            ...
            u.on("click", I, P), u.on("keydown", document, function (e) {
                ...
                if (((e.ctrlKey || e.metaKey) && 13 === n && P(), 9 === n) && "veditor" ==
        ...
        var a = /[&<>"'`\\]/g,
            ...
            d = {
                on: function (e, t, n, r) {
                    e = e.split(" ");
                    for (var i = 0, o = e.length; i < o; i++) d.off(e[i], t, n, r), t.addEventListener ?
                        t.addEventListener(e[i], n, r || !1) : t.attachEvent ? t.attachEvent("on" +
                            e[i], n) : t["on" + e[i]] = n
                },
                off: function (e, t, n, r) {
                    t.removeEventListener ? t.removeEventListener(e, n, r || !1) : t.detachEvent ?
                ...
                clearAttr: function (e) {
                    var t = e.attributes,
                        n = ["align", "alt", "class", "disabled", "href", "id", "target", "title",
                            "type", "style", "src"];
                    return d.each(t, function (t, r) {
                        ...
                        if ("style" === i) {
                            ...
                            d.each(o.split(";"), function (t, n) {
                                if (n.indexOf("color") > -1) return d.attr(e,
                                    "style", n), !1;
